...
namespace SistemaDeRentCar.Controllers
{
    public class EmpleadoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Cedula,TandaLabor,ProcientoComision,FechaIngreso,Estado")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Cedula,TandaLabor,ProcientoComision,FechaIngreso,Estado")] Empleado empleado)
        {
            if (id != empleado.Id)
            {
                return NotFound();
